...
const challenges: Challenge[] = [
  ...
  },
  {
    ...
    subject: "Science",
    level: "Starter",
    title: "Help a plant thrive",
    skillTitle: "Plant Needs Investigator",
    description: "Show what a healthy plant needs to grow.",
    instruction:
      "Draw a healthy plant and explain how sunlight, water, air and nutrients help it grow.",
    icon: Beaker,
    accent: "#C8F36A",
    softAccent: "rgba(200, 243, 106, 0.14)",
    conceptLabels: ["sunlight", "water", "air", "nutrients"],
    conceptGroups: [
      ["sunlight", "sun", "light"],
      ["water", "rain", "moisture"],
      ["air", "carbon dioxide", "co2"],
      ["nutrient", "nutrients", "soil", "minerals"],
    ],
    reasoningWords: ["because", "helps", "needs", "grow", "make food", "roots"],
  },
  {
    id: 5,
    subject: "Mathematics",
    level: "Explorer",
    title: "Show one half",
    skillTitle: "Fraction Designer",
    description: "Create and explain two equal parts.",
    instruction:
      "Use a drawing or an object to show one half, then explain why both parts must be equal.",
    icon: Shapes,
    accent: "#7657FF",
    softAccent: "rgba(118, 87, 255, 0.14)",
    conceptLabels: ["one whole", "two parts", "equal parts", "one part is one half"],
    conceptGroups: [
      ["whole", "one object", "one shape"],
      ["two parts", "2 parts", "divided into two", "split into two"],
      ["equal", "same size", "same amount"],
      ["one half", "1/2", "one of the parts", "one part"],
    ],
    reasoningWords: ["because", "equal", "divide", "split", "same", "means"],
  },
  {
    id: 6,
    subject: "Reading",
    ...
    skillTitle: "Story Sequence Builder",
    description: "Explain what happened first, next and last.",
    instruction:
      "Choose a familiar short story and explain its beginning, middle and ending in the correct order.",
    icon: BookOpen,
    accent: "#FF9D4D",
    softAccent: "rgba(255, 157, 77, 0.14)",
    conceptLabels: ["the beginning", "the middle", "the ending", "correct event order"],
    conceptGroups: [
      ["beginning", "first", "started"],
      ["middle", "next", "then", "after"],
      ["ending", "last", "finally", "ended"],
      ["order", "sequence", "before", "after"],
    ],
    reasoningWords: ["first", "next", "then", "after", "finally", "because"],
  },
  {
    id: 7,
    subject: "Science",
    level: "Explorer",
    title: "Test pushes and pulls",
    skillTitle: "Force and Motion Explorer",
    description: "Demonstrate how a force changes movement.",
    instruction:
      "Move an object using a push and a pull, then explain how each force changes its movement.",
    icon: Beaker,
    accent: "#47D7FF",
    softAccent: "rgba(71, 215, 255, 0.14)",
    conceptLabels: ["force", "push", "pull", "change in movement"],
    conceptGroups: [
      ["force", "strength", "energy"],
      ["push", "pushed", "away"],
      ["pull", "pulled", "toward", "closer"],
      ["move", "movement", "speed", "direction", "stop", "faster", "slower"],
    ],
    reasoningWords: ["because", "causes", "changes", "direction", "speed", "when"],
  },
  {
    id: 8,
    subject: "Mathematics",
    level: "Explorer",
    title: "Build the number 347",
    skillTitle: "Place Value Builder",
    description: "Show hundreds, tens and ones.",
    instruction:
      "Represent 347 using objects or a drawing, then explain the value of each digit.",
    icon: Shapes,
    accent: "#FF9D4D",
    softAccent: "rgba(255, 157, 77, 0.14)",
    conceptLabels: ["three hundreds", "four tens", "seven ones", "expanded value"],
    conceptGroups: [
      ["three hundred", "3 hundred", "300"],
      ["four tens", "4 tens", "40"],
      ["seven ones", "7 ones", "7 units"],
      ["347", "300 + 40 + 7", "expanded", "place value"],
    ],
    reasoningWords: ["hundreds", "tens", "ones", "value", "digit", "means"],
  },
  {
    id: 9,
    subject: "Reading",
    level: "Explorer",
    title: "Find cause and effect",
    skillTitle: "Cause and Effect Detective",
    description: "Connect what happened with why it happened.",
    instruction:
      "Choose an event from a familiar story, explain what caused it and describe the effect that followed.",
    icon: BookOpen,
    accent: "#C8F36A",
    softAccent: "rgba(200, 243, 106, 0.14)",
    conceptLabels: ["the event", "its cause", "its effect", "evidence from the story"],
    conceptGroups: [
      ["event", "happened", "action"],
      ["cause", "because", "reason", "why"],
      ["effect", "result", "so", "therefore", "led to"],
      ["story", "text", "passage", "said", "shows"],
    ],
    reasoningWords: ["because", "so", "therefore", "caused", "result", "shows"],
  },
];
